...
export class BroadcastManager {
  ...
  private incomingEvents: any[];
  private backupEvents: any[];
  private nextGameCursor: null;
        ...
        switch (obj.type) {
          case "start-broadcast-resp":
            if (obj.recoveryGameCursor) {
              const firstIncoming: any = _.first(this.incomingEvents) || {};
          ...
          case "get-broadcasts-resp":
            ...
            const prevBroadcast = this.broadcastId ? broadcastsById[this.broadcastId] : null;
